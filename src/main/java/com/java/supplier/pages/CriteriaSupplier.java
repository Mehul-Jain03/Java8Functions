package com.java.supplier.pages;
...
public class CriteriaSupplier {
    ...
    private static Predicate<List<WebElement>> allAUFemale = allFemale.and(allAU);

    private static final Map<String, Predicate<List<WebElement>>> MAP = new HashMap<String, Predicate<List<WebElement>>>();
    ...
    static {
        ...
        MAP.put("allAU",allAU);
        MAP.put("allAUFemale",allAUFemale);
    }
